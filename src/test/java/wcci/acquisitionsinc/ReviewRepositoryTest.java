...
//		review1 = new Review("title", "imageUrl", "category", "content");
//		review2 = new Review("title2", "imageUrl2", "category2", "content2");
//		review3 = new Review("title3", "imageUrl3", "category3", "content3");
//		review4 = new Review("title4", "imageUrl4", "category4", "content4");
...
//		Collection<Review> allReviews = underTest.getAllReviews();
//		Review default1 = new Review("title", "image", "category", "content");
//		Review default2 = new Review("title2", "image2", "category2", "content2");
